...
/////////////////////
gui::RichButton::RichButton()
{
    
}

gui::RichButton::RichButton(sf::String s, sf::Font& font, sf::Vector2f position, sf::Uint8 style)
{
    //set position
    m_position = position;
...
void gui::RichButton::setSize(unsigned int size)
{
    m_fontSize = size;
...
void gui::RichButton::setStyle(sf::Uint8 style)
{
    //set RichButton style
    m_style = style;
...
void gui::RichButton::setFont(sf::Font& font)
{
    m_text.setFont(font);
    m_shadow.setFont(font);
}

void gui::RichButton::update(sf::Event& e, sf::RenderWindow& window)
{
    ...
    sf::Vector2f m_mousePosition = getGame()->window->mapPixelToCoords(sf::Mouse::getPosition(window));
...
void gui::RichButton::draw(sf::RenderTarget& target,sf::RenderStates states) const
{
    switch(m_style)
    {
        case gui::style::none:
